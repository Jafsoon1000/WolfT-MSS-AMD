...
[![Pine Script](https://img.shields.io/badge/Pine_Script-v5-152238?logo=tradingview)](https://www.tradingview.com/pine-script-docs/en/v5/Introduction.html)
[![TradingView](https://img.shields.io/badge/TradingView-Indicator-131722?logo=tradingview)](https://www.tradingview.com/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Welcome! This document covers the `XAUUSD_Liquidity_Purge.pine` script designed specifically to track **Session-Based Liquidity Purges** and algorithmic footprints (Fair Value Gaps & Market Structure Shifts) on Gold (XAUUSD).

---

## 📑 Table of Contents
- [1. Core Strategy: The Power of 3 (AMD Model)](#-1-core-strategy-the-power-of-3-amd-model)
- [2. Installation on TradingView](#-2-installation-on-tradingview)
- [3. Customizing Indicator Settings](#-3-customizing-indicator-settings)
- [4. Best Practices for Trading Gold](#-4-best-practices-for-trading-gold-in-2026)

---

## 🧠 1. Core Strategy: The Power of 3 (AMD Model)
...
7. > ⚠️ **Important:** Click **Save** and then click **Add to Chart**.

---

## ⚙️ 3. Customizing Indicator Settings
...
## 📈 4. Best Practices for Trading Gold in 2026

> 💡 **Pro Tip:** Always stay vigilant for Dollar Index (DXY) inversions. If the DXY taps a major HTF Premium/Discount array exactly around 15:30 (NY Open), Gold will often execute an inverse reversal sweep. Trust the algorithm over retail patterns.

<br/>
<div align="center">
  <b>Developed for the Wolf Trading Ecosystem</b><br>
